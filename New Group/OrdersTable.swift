...
class OrdersTable: UIViewController,UITableViewDelegate , UITableViewDataSource, passDataBack {
    var onOff=false
    ...
    var patient = [Patient]()
    var color = UIColor(red: 0.9, green:0.0, blue: 0, alpha: 0.1)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        //color = UIColor(red: 0, green:0.9, blue: 1, alpha: 0.1)
        let currCell = tableView.cellForRow(at: indexPath)
        //currCellObject?.isHidden = true
        currCell?.backgroundColor = UIColor (red: 0, green: 0.9, blue: 0, alpha: 0.1)
